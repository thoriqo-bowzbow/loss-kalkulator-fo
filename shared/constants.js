/**
 * Konstanta standar loss & katalog perangkat — sumber tunggal untuk web & CLI.
 * Perubahan nilai di sini otomatis berlaku di kedua platform.
 */

/** @typedef {import('./types').FiberType} FiberType */
/** @typedef {import('./types').LossConstants} LossConstants */
/** @typedef {import('./types').OpticalClass} OpticalClass */
/** @typedef {import('./types').Splitter} Splitter */
/** @typedef {import('./types').Wavelength} Wavelength */

const DEFAULT_SPLICE_LOSS = 0.1;
const DEFAULT_CONNECTOR_LOSS = 0.3;

export const WAVELENGTHS = /** @type {Wavelength[]} */ ([1310, 1490, 1550]);

const DEFAULT_FIBER_TYPES = /** @type {FiberType[]} */ ([
  { id: 'g652d', label: 'G.652.D (Standard)', attenuation: { 1310: 0.35, 1490: 0.28, 1550: 0.22 } },
  { id: 'g657a', label: 'G.657.A (Bend-insensitive)', attenuation: { 1310: 0.35, 1490: 0.28, 1550: 0.22 } },
  { id: 'g655', label: 'G.655 (NZ-DSF)', attenuation: { 1310: 0.4, 1490: 0.3, 1550: 0.24 } },
]);

export const FIBER_TYPES = DEFAULT_FIBER_TYPES;

export const DEFAULT_SPLITTERS = /** @type {Splitter[]} */ ([
...
export const OPTICAL_CLASSES = /** @type {OpticalClass[]} */ ([
...
export const DEFAULT_CONSTANTS = /** @type {LossConstants} */ ({
